        ...
        contents: [
          ...
          },
          {
            ...
            contents: [
              ...
              {
                type: "text",
                text: `Paper Planes วงร็อกอัลเทอร์เนทีฟ จากค่าย Genie records
                ที่ประกอบไปด้วย 2 สมาชิก ฮาย ธันวา (ร้องนำ)
                และ เซน นครินทร์ (เบส)
                เดบิวต์อย่างเป็นทางการในช่วงปี พ.ศ. 2560
                ภายใต้โปรโปรเจกต์อัลบั้ม Showroom Vol.3
                และปล่อยผลงานเพลงแรกออกมาในชื่อเพลง
                ก่อนเสียเธอไป ต่อด้วย ซ้ำซ้ำ, เก็บฉันไว้ทำไม, คำตอบเดิม`,
                weight: "regular",
                contents: [],
              },
            ],
